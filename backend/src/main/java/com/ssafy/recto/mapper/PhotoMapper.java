...
public interface PhotoMapper {
	...
	@Insert("Insert INTO Photo ( photo_seq, user_seq, photo_id, photo_date, video_url, phrase, photo_pwd, design, publication) \n"
			+ "VALUES ( #{photo.photo_seq},#{photo.user_seq},#{photo.photo_id},#{photo.photo_date},#{photo.video_url},#{photo.phrase},#{photo.photo_pwd},#{photo.design},#{photo.publication})")
